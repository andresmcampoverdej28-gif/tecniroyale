...
const GenAI = () => {
  ...
  const consultarGemini = async (preguntaUsuario: string) => {
    ...
    try {
      ...
      const contextoBrawlers = brawlers
        .map((b) => `${b.name} (Clase: ${b.class?.name || "N/A"})`)
        .join(", ");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View className="mb-6 items-center">
          <View className="flex-row items-center mb-2">
            <Image
              source={{ uri: "https://cdn.brawlify.com/brawler/Rico.png" }}
      ...
      {/* Input Section */}
      <View className="pt-4 border-t border-gray-700 bg-gray-900">
